...
# if recommended_movie and cost:
#     print("Recommended movie:", recommended_movie, "and the cost to get here from the initial state is: ", cost)
# else:
...
def depth_first_tree_search(problem):
    frontier = [Node.root(problem.initial_state)]  # Stack (LIFO)
    net = Network(notebook=True, height="600px", width="100%")  # Initialize a pyvis Network
